...
import { idlFactory } from './challenge-2-frontend.did.js';
export { idlFactory } from './challenge-2-frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CHALLENGE_2_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./challenge-2-frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the challenge-2-frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./challenge-2-frontend.did.js")._SERVICE>}
 */
export const challenge_2_frontend = createActor(canisterId);
